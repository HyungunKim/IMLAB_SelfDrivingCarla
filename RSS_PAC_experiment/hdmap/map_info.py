    ...
    def game_loop(self):
        ...
        try:
            ...
            while True:
                ...
                pygame.event.pump()
                x = self.car.get_location().x
                y = self.car.get_location().y
                ...
                print(f"{self.car.get_location()} is in road {rnum}, lane {lnum}.", end='\r')
